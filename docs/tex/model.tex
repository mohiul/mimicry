...
\begin{quotation}
``Modeling, it should be clear is an art form. It depends on the experience and taste of the modeler. In this it is much like cartooning. The modeler (cartoonist) must decide which features to make salient (exaggerate), and which features to eliminate (avoid), in order to answer the questions (make the political point)" \cite{holland1996}.
\end{quotation}
...
\centering
\begin{tabular}{cc}
		\multicolumn{2}{c}{ \includegraphics[scale=0.50]{images/cells-front} } \\
		\includegraphics[scale=0.40]{images/cells-top} & \includegraphics[scale=0.40]{images/cells-side} \\
\end{tabular}
